...
console.log('====================================');
console.log(isPayTest ? "yes" : "no");
console.log('====================================');
  const answer = isPayTest
...
const iPromise = (data: {
  ...
  return new Promise(async (resolve, reject) => {
    try {
      await displayInvoice(data.pesanan, data.user.isLuckyPerson, data.isUserPay);
      ...
      if (error instanceof Error) {
        ...
        console.error("🚀 !!!! Invailid Error:", error)
        reject(false)
      };
    }
  });
